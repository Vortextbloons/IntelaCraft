...
import type { Vec3i } from "./types.js";
...
export interface ExpectedWorldState { version:1; dimension:DimensionId; bounds:import("./types.js").RegionBounds; blocks:Array<{position:Vec3i;blockType:string}>; requiredAir:Vec3i[]; materials:Record<string,number> }
export interface BuildVerification { expectedBlocks:number; correctBlocks:number; missing:Array<{position:Vec3i;blockType:string}>; incorrect:Array<{position:Vec3i;expected:string;actual:string}>; unexpected:Array<{position:Vec3i;blockType:string}>; completionPercent:number }
